...
public class VentaPDF {
    ...
    public void generarFacturaPDF() {
        try {
            ...
            Image img = Image.getInstance("src/img/papeleria.png");
            ...
            String nombre = "Papeleria La Estrella";
            String telefono = "924248561";
            String direccion = "Mina Centro";
            String razon = "Todos tus materiales los encuentras con nosotros";
